      ...
      <div className="container-wide relative z-10">
        ...
        <div className="grid md:grid-cols-1 gap-8 max-w-3xl mx-auto">
          {services.map((service, index) => (
            <div
              key={service.title}
              className={`relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 border ${service.borderColor} hover:border-pink-500/50 transition-all duration-500 overflow-hidden group hover:-translate-y-2 hover:scale-[1.02] animate-slide-up`}
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-4">
                  {service.items.map((item) => (
                    ...
                    >
                      <div className={`w-6 h-6 rounded-full bg-pink-500/20 flex items-center justify-center flex-shrink-0 border ${service.borderColor}`}>
